...
class Menu:
    ...
    def interactive_term(self):
        while True:
            choice = int(input(
                'Welcome to the Bank Menu. Please select from the following options.\n1. Teller Options\n2. Customer Options\n3. Save Data\n4. Load Data\n5. Quit\n'))
            if choice == 5:
                ...
                while True:
                    t_choice = int(input(
                        'Welcome to the teller options. Please select from the following choice.\n1. Add Customer\n2. Add account\n3. Remove Account\n4. Quit\n'))
                    if t_choice == 4:
                        print('Have a great day!')
                        break
                ...
                while True:
                    c_choice = int(input(
                        "Welcome to the customer options. Please select from the following choices.\n1. Balance Inquiry\n2. Deposit\n3. Withdrawl\n4. Quit\n"))
                    if c_choice == 4:
                        break
                    elif c_choice == 1:
                        account_number = int(
                            input("Please enter the account number you would like to see the balance of.\n"))
